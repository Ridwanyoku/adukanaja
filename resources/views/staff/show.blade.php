    ...
    <div class="container mx-auto p-4">
        ...
        @if ($report)
            <div class="bg-white p-4 rounded shadow">
                ...
                <p><strong>User:</strong> {{ $report->user ? $report->user->nama : 'Anonymous' }}</p>
                ...
                @endif
                <a href="{{ route('staff.response', $report->id) }}" class="mt-4 inline-block bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Add Response</a>
